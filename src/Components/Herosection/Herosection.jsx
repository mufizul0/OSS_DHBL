          ...
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 lg:w-5/12">
              <div class="hero-content">
                ...
                >
                  <h1 class="text-transparent bg-clip-text bg-gradient-to-r sm:text-8xl text-2xl from-blue-400 to-emerald-600 mb-3  font-bold leading-snug sm:text-[42px] lg:text-[30px] xl:text-[42px] ">
                    Here you can
                    <br />
                    <span className="sm:text-8xl text-6xl mt-2">
                  ...
                  <p class="text-body-color text-sm mb-8 max-w-[480px] sm:text-base">
                    ...
                    our Digital Hub Bangladesh Ltd, we can ensure you that we will take your
                ...
                >
                  <ul class="flex flex-wrap items-center">
                    <li>
                      <Link
                        to="#"
                        class="bg-orange-400 inline-flex items-center justify-center rounded-lg py-4 px-6 text-center text-base font-normal text-white hover:bg-blue-500 sm:px-10 lg:px-8 xl:px-10"
                      >
                        Get Started
                      </Link>
                    </li>
                ...
                <motion.div
                  ...
                  class="clients pt-16"
                >
                  <h6 class="text-body-color mb-2 flex items-center text-lg font-normal">
                 <span className='bg-blend-color-burn'>Some Of Our Clients</span>
                    <span class="bg-body-color ml-2 inline-block h-[1px] w-8"></span>
                  </h6>
                  <div class="flex items-center">
                    <div class="mr-4 w-full py-3">
                      <img
                        src="https://i.ibb.co/jWqvkft/BCIlogomain-fotor-202308040232.png"
                        alt="BCI"
                      />
                    </div>
                    <div class="mr-4 w-full py-3">
                      <img
                        src="https://i.ibb.co/10PQch7/SEIP.jpg"
                        alt="graygrids"
                      />
                    </div>
                    <div class="mr-4 w-full py-3">
                      <img
                        src="https://i.ibb.co/BjLK9td/shipping.jpg"
                        alt="Tricom"
                      />
                    </div>
                  </div>
