...
import {FaFacebookSquare, FaInstagram, FaTwitterSquare, FaDribbbleSquare} from 'react-icons/fa'
    ...
    <div className="overflow-x-hidden max-w-screen font-poppins">
      ...
      <div className="sm:flex justify-between py-10 px-8 grid bg-gray-900">
        <div className="text-white">
         ...
         Digital Hub Bangladesh Ltd
          </h1>
          <p className="py-4">
            Welcome to  Digital Hub Bangladesh Ltd, where we transform raw information
          ...
          <div className="flex md:w-[75%] justify-between my-3 text-blue-200">
            {/* social media icons */}
      ...
      <div className="sm:mx-auto pt-10 pb-8 sm:grid flex-row lg:grid-cols-3 w-screen gap-8 text-gray-300 bg-gray-800 ">
        ...
        <p className='pt-4 text-pink-600 text-lg  flex justify-center text-center'>All Rights Reserved 2023 -  <span className='text-amber-500'> Digital Hub Bangladesh Ltd</span></p>
      </div>
