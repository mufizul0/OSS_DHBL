      ...
      <>
        <section class="py-20 lg:py-[120px] bg-gray-100/50 font-poppins">
          <div class="container mx-auto">
            <div class="bg-orange-500 relative z-10 sm:-mt-10 sm:-mb-10 overflow-x-hidden rounded py-12 px-8 md:p-[70px]">
                ...
                <div class="w-full px-4 lg:w-1/2">
                  <div class="flex sm:flex-wrap sm:justify-end">
                    ...
                    >
                      ...
                      <button
                        href="#"
                        class="my-1 inline-block rounded bg-[#4b4b4b] py-4 px-6 text-base font-medium text-white transition hover:bg-opacity-90 md:px-9 lg:px-6 xl:px-9"
                      >
                        Get Started
                      </button>
                    </motion.div>
