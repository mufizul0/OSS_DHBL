    ...
    <div>
      ...
      <div className="max-w-screen overflow-hidden font-poppins">
          ...
          <div className="mt-20">
            ...
            >
              <h1 className="flex justify-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-emerald-500 font-extrabold text-[3rem]">
                Who are we and whay are wee so good ?
              </h1>
            </motion.div>
        ...
        <div className="h-[40rem] sm:mt-20 mt-[20%] mb-20">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.10716295151!2d90.36905900958685!3d23.743557678586065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf4b960369c5%3A0x222c3f3f9659150c!2sDigital%20Hub%20Bangladesh%20Ltd!5e0!3m2!1sen!2sbd!4v1703327301877!5m2!1sen!2sbd" width="1000" height="450"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
