            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  ...
                  Welcome to Digital Hub Bangladesh Ltd, where we transform raw information into actionable insights. With cutting-edge technology and a team of skilled analysts, we specialize in deciphering complex data sets to uncover valuable patterns and trends with which wee take your business to the Next Level
                  </p>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      ...
                      House: 89/A, Road 8A [Old 15] Behind KEARI PLAZA Dhanmondi, Dhaka 1209.
                      </p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative rounded-lg bg-slate-500 p-8 shadow-lg sm:p-12">
                  <form>
                    <div class="mb-6">
                      <input
                        type="text"
