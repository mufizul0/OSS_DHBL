              ...
              <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                <div>
                  <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl ">
                    Empowering  Business  All More came 
                  </h2>
                    ...
                    <div className="mt-12 space-y-12">
                      ...
                      >
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mt-2 ">
                          Web design and development is an umbrella term that describes the process of creating a websiteStarting a web design and development digital agency can be challenging, but with the right strategy and dedication, it can also be very rewarding. Good luck with your venture!
                          </p>
                        </div>
                      </motion.div>
                      <motion.div
                      ...
                      >
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mt-2 ">
                            Our trained experts ensure smooth implementation and
                            ongoing guidance. Leverage our software effectively
                            with personalized assistance.Discover the full potential of our services through the expertise 
                          </p>
                        </div>
                      </motion.div>
                    </div>
                  ...
                  <div ref={ref}>
                    ...
                    >
                      <img
                        src={image1}
                        alt="image1"
                        className="taos:translate-x-[200px] w-full max-h-full taos:opacity-0 hover:-translate-y-2 transition ease-in-out duration-300 hover:drop-shadow-xl mx-auto rounded-lg shadow-lg dark:bg-gray-500"
                      />
                    </motion.div>
                  </div>
                </div>
                    ...
                    <div className="lg:col-start-2">
                      ...
                      <div className="mt-12 space-y-12">
                        ...
                        >
                          ...
                          <div className="ml-4 hover:bg-gray-100 hover:shadow-md transition duration-300 ease-in-out ">
                            <h4 className="text-lg font-medium leading-6 ">
                              Personalized Solutions
                            </h4>
                            <p className="mt-2 ">
